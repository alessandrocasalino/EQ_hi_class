...
int background_gravity_functions(
  ...
  if (pba->field_evolution_smg == _TRUE_) {
    ...
    if (pba->gravity_model_smg == quintessence_monomial) {
    ...
    else if (pba->gravity_model_smg == quintessence_extended) {
      ...
      G4 = 1/2. + G4_smg;
      G4_phi = fun_phi/2.;
      G4_phiphi = fun_phiphi/2.;

    }

    else if (pba->gravity_model_smg == quintessence_extended_symmetron) {
...
int background_gravity_parameters(
  ...
  switch (pba->gravity_model_smg) {
   ...
   case quintessence_extended:
     printf("Modified gravity: quintessence_extended with parameters: \n");
     printf("-> alpha = %g, V0 = %g, beta = %g, phi_prime_ini = %g, phi_ini = %g \n",
